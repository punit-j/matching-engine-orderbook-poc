...
func bindGnosis(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := GnosisMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// GnosisSafeModuleTransactionIterator is returned from FilterSafeModuleTransaction and is used to iterate over the raw logs and unpacked data for SafeModuleTransaction events raised by the Gnosis contract.
type GnosisSafeModuleTransactionIterator struct {
	Event *GnosisSafeModuleTransaction // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GnosisSafeModuleTransactionIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GnosisSafeModuleTransaction)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GnosisSafeModuleTransactionIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GnosisSafeModuleTransactionIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// GnosisSafeModuleTransaction represents a SafeModuleTransaction event raised by the Gnosis contract.
type GnosisSafeModuleTransaction struct {
	Module    common.Address
	To        common.Address
	Value     *big.Int
	Data      []byte
...
func (_Gnosis *GnosisFilterer) FilterSafeModuleTransaction(opts *bind.FilterOpts) (*GnosisSafeModuleTransactionIterator, error) {

	logs, sub, err := _Gnosis.contract.FilterLogs(opts, "SafeModuleTransaction")
	if err != nil {
		return nil, err
	}
	return &GnosisSafeModuleTransactionIterator{contract: _Gnosis.contract, event: "SafeModuleTransaction", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SafeModuleTransaction(address module, address to, uint256 value, bytes data, uint8 operation)
func (_Gnosis *GnosisFilterer) WatchSafeModuleTransaction(opts *bind.WatchOpts, sink chan<- *GnosisSafeModuleTransaction) (event.Subscription, error) {

	logs, sub, err := _Gnosis.contract.WatchLogs(opts, "SafeModuleTransaction")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GnosisSafeModuleTransaction)
				if err := _Gnosis.contract.UnpackLog(event, "SafeModuleTransaction", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SafeModuleTransaction(address module, address to, uint256 value, bytes data, uint8 operation)
func (_Gnosis *GnosisFilterer) ParseSafeModuleTransaction(log types.Log) (*GnosisSafeModuleTransaction, error) {
	event := new(GnosisSafeModuleTransaction)
	if err := _Gnosis.contract.UnpackLog(event, "SafeModuleTransaction", log); err != nil {
		return nil, err
	}
...
// GnosisSafeMultiSigTransactionIterator is returned from FilterSafeMultiSigTransaction and is used to iterate over the raw logs and unpacked data for SafeMultiSigTransaction events raised by the Gnosis contract.
type GnosisSafeMultiSigTransactionIterator struct {
	Event *GnosisSafeMultiSigTransaction // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *GnosisSafeMultiSigTransactionIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GnosisSafeMultiSigTransaction)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *GnosisSafeMultiSigTransactionIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GnosisSafeMultiSigTransactionIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// GnosisSafeMultiSigTransaction represents a SafeMultiSigTransaction event raised by the Gnosis contract.
type GnosisSafeMultiSigTransaction struct {
	To             common.Address
	Value          *big.Int
	Data           []byte
	Operation      uint8
...
func (_Gnosis *GnosisFilterer) FilterSafeMultiSigTransaction(opts *bind.FilterOpts) (*GnosisSafeMultiSigTransactionIterator, error) {

	logs, sub, err := _Gnosis.contract.FilterLogs(opts, "SafeMultiSigTransaction")
	if err != nil {
		return nil, err
	}
	return &GnosisSafeMultiSigTransactionIterator{contract: _Gnosis.contract, event: "SafeMultiSigTransaction", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SafeMultiSigTransaction(address to, uint256 value, bytes data, uint8 operation, uint256 safeTxGas, uint256 baseGas, uint256 gasPrice, address gasToken, address refundReceiver, bytes signatures, bytes additionalInfo)
func (_Gnosis *GnosisFilterer) WatchSafeMultiSigTransaction(opts *bind.WatchOpts, sink chan<- *GnosisSafeMultiSigTransaction) (event.Subscription, error) {

	logs, sub, err := _Gnosis.contract.WatchLogs(opts, "SafeMultiSigTransaction")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(GnosisSafeMultiSigTransaction)
				if err := _Gnosis.contract.UnpackLog(event, "SafeMultiSigTransaction", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SafeMultiSigTransaction(address to, uint256 value, bytes data, uint8 operation, uint256 safeTxGas, uint256 baseGas, uint256 gasPrice, address gasToken, address refundReceiver, bytes signatures, bytes additionalInfo)
func (_Gnosis *GnosisFilterer) ParseSafeMultiSigTransaction(log types.Log) (*GnosisSafeMultiSigTransaction, error) {
	event := new(GnosisSafeMultiSigTransaction)
	if err := _Gnosis.contract.UnpackLog(event, "SafeMultiSigTransaction", log); err != nil {
		return nil, err
	}
