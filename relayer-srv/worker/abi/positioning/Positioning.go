...
// FilterFundingUpdated is a free log retrieval operation binding the contract event 0x6c26cfb44880f01c47ae997cdeb7d31d798fd8cc0235c99b69d6f2926f380544.
//
// Solidity: event FundingUpdated(address indexed baseToken, uint256 markTwap, uint256 indexTwap, int256 fundingRate)
...
// WatchFundingUpdated is a free log subscription operation binding the contract event 0x6c26cfb44880f01c47ae997cdeb7d31d798fd8cc0235c99b69d6f2926f380544.
//
// Solidity: event FundingUpdated(address indexed baseToken, uint256 markTwap, uint256 indexTwap, int256 fundingRate)
...
// ParseFundingUpdated is a log parse operation binding the contract event 0x6c26cfb44880f01c47ae997cdeb7d31d798fd8cc0235c99b69d6f2926f380544.
//
// Solidity: event FundingUpdated(address indexed baseToken, uint256 markTwap, uint256 indexTwap, int256 fundingRate)
...
type PositioningPositionChanged struct {
	Trader                    [2]common.Address
	BaseToken                 common.Address
	ExchangedPositionSize     [2]*big.Int
	ExchangedPositionNotional [2]*big.Int
	Fee                       [2]*big.Int
	OrderType                 [2][4]byte
	IsShort                   [2]bool
	Raw                       types.Log // Blockchain specific contextual infos
...
// FilterPositionChanged is a free log retrieval operation binding the contract event 0x28b59edfbfc8ee20fa77030edb0847e32005fdf2a86c5e093d5734d67fc55d8b.
//
// Solidity: event PositionChanged(address[2] trader, address indexed baseToken, int256[2] exchangedPositionSize, int256[2] exchangedPositionNotional, uint256[2] fee, bytes4[2] orderType, bool[2] isShort)
func (_Positioning *PositioningFilterer) FilterPositionChanged(opts *bind.FilterOpts, baseToken []common.Address) (*PositioningPositionChangedIterator, error) {
	...
	logs, sub, err := _Positioning.contract.FilterLogs(opts, "PositionChanged", baseTokenRule)
	if err != nil {
		return nil, err
	}
...
// WatchPositionChanged is a free log subscription operation binding the contract event 0x28b59edfbfc8ee20fa77030edb0847e32005fdf2a86c5e093d5734d67fc55d8b.
//
// Solidity: event PositionChanged(address[2] trader, address indexed baseToken, int256[2] exchangedPositionSize, int256[2] exchangedPositionNotional, uint256[2] fee, bytes4[2] orderType, bool[2] isShort)
func (_Positioning *PositioningFilterer) WatchPositionChanged(opts *bind.WatchOpts, sink chan<- *PositioningPositionChanged, baseToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Positioning.contract.WatchLogs(opts, "PositionChanged", baseTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParsePositionChanged is a log parse operation binding the contract event 0x28b59edfbfc8ee20fa77030edb0847e32005fdf2a86c5e093d5734d67fc55d8b.
//
// Solidity: event PositionChanged(address[2] trader, address indexed baseToken, int256[2] exchangedPositionSize, int256[2] exchangedPositionNotional, uint256[2] fee, bytes4[2] orderType, bool[2] isShort)
